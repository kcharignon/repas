 ...
 */
final class Version20250121160124 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE shopping_list (id VARCHAR(255) NOT NULL, date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, locked BOOLEAN NOT NULL, PRIMARY KEY(id))');
        $this->addSql('COMMENT ON COLUMN shopping_list.date IS \'(DC2Type:datetime_immutable)\'');
        $this->addSql('CREATE TABLE shopping_list_recipe (shopping_list VARCHAR(255) NOT NULL, recipe VARCHAR(36) NOT NULL, PRIMARY KEY(shopping_list, recipe))');
        $this->addSql('CREATE INDEX IDX_C14F483F3DC1A459 ON shopping_list_recipe (shopping_list)');
        $this->addSql('CREATE INDEX IDX_C14F483FDA88B137 ON shopping_list_recipe (recipe)');
        ...
        $this->addSql('ALTER TABLE shopping_list_recipe ADD CONSTRAINT FK_C14F483F3DC1A459 FOREIGN KEY (shopping_list) REFERENCES shopping_list (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE shopping_list_recipe ADD CONSTRAINT FK_C14F483FDA88B137 FOREIGN KEY (recipe) REFERENCES recipe (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE shopping_list_recipe DROP CONSTRAINT FK_C14F483F3DC1A459');
        $this->addSql('ALTER TABLE shopping_list_recipe DROP CONSTRAINT FK_C14F483FDA88B137');
