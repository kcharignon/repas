 ...
 */
final class Version20250116161046 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE recipe (id VARCHAR(36) NOT NULL, author_id VARCHAR(36) NOT NULL, recipe_type VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, people_number INT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_DA88B137F675F31B ON recipe (author_id)');
        $this->addSql('CREATE INDEX IDX_DA88B137F3C50DF6 ON recipe (recipe_type)');
        $this->addSql('CREATE TABLE recipe_row (id VARCHAR(36) NOT NULL, ingredient VARCHAR(255) NOT NULL, unit VARCHAR(255) NOT NULL, recipe_id VARCHAR(36) NOT NULL, quantity DOUBLE PRECISION NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE INDEX IDX_F567929759D8A214 ON recipe_row (recipe_id)');
        ...
        $this->addSql('ALTER TABLE recipe ADD CONSTRAINT FK_DA88B137F3C50DF6 FOREIGN KEY (recipe_type) REFERENCES recipe_type (slug) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE recipe_row ADD CONSTRAINT FK_F567929759D8A214 FOREIGN KEY (recipe_id) REFERENCES recipe (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE recipe DROP CONSTRAINT FK_DA88B137F3C50DF6');
        ...
        $this->addSql('ALTER TABLE recipe_row DROP CONSTRAINT FK_F567929759D8A214');
