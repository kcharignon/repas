 ...
 */
final class Version20250201140315 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE shopping_list_ingredient (id VARCHAR(255) NOT NULL, shopping_list_id VARCHAR(255) NOT NULL, ingredient_slug VARCHAR(255) NOT NULL, unit_slug VARCHAR(255) NOT NULL, quantity DOUBLE PRECISION NOT NULL, PRIMARY KEY(id))');
