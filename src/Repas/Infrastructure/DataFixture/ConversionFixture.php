...
class ConversionFixture extends Fixture implements DependentFixtureInterface, FixtureGroupInterface
{
    private const array CONVERSIONS = [
        ...
        [
            "ingredient" => "pain-tartine",
            "startUnit" => "tranche",
            "endUnit" => "piece",
            "coefficient" => 1,
        ],
        [
            "ingredient" => "creme-fraiche-epaisse",
            "startUnit" => "litre",
            "endUnit" => "gramme",
            "coefficient" => 980,
        ],
